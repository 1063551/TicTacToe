...
function displayGrid() {
    ...
    imageRedo.setAttribute("src", "https://github.com/1063551/TicTacToe/blob/master/imgs/redo.png")
        ...
        s.onclick = function () {
            ...
            if (!s.hasChildNodes()) {
                ...
                if (count % 2 == 0 || gMode == 0) {
                    ...
                    im.setAttribute("src", "https://github.com/1063551/TicTacToe/blob/master/imgs/O.png")
                    ...
                    if (gMode == 0 && count < 4) {
                        ...
                        while (loop != false) {
                            ...
                            if (randEl.hasChildNodes() == false) {
                                let im = document.createElement("img")
                                im.setAttribute("src", "https://github.com/1063551/TicTacToe/blob/master/imgs/X.png")
